...
public class ImageData {
    ...
    public static int[] files = new int[]
            {R.drawable.usd_100, R.drawable.usd_1, R.drawable.rmb_100, R.drawable.mxn_50, R.drawable.mxn_100};
    // name of the image
    public static String[] files_names =
            {"100 USD bill", "1 USD bill", "100 RMB bill", "50 Mexican Pesos Bill", "100 Mexican Pesos Bill"};
    // type of the image. If the image is a bill, the type must match Bloomberg symbols.
    public static String[] types =
            {"USD", "USD", "CNY", "MXN", "MXN"};
    // face value of the bill. If the image is not a bill, set it to 0.
